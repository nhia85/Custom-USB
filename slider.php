<body style="padding: 40px; margin: 0px; background-color: #fff; font-family: Arial, sans-serif;">
</br></br>
...
<!----  some images from customusb.com  ---->
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 800px; height: 456px; overflow: hidden; visibility: hidden; background-color: #24262e;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 800px; height: 356px; overflow: hidden;">
            <div data-p="144.50" style="display: none;">
                ...
                <img data-u="thumb" src="slider/img/01.jpg" />
            </div>
            <div data-p="144.50" style="display: none;">
                <img data-u="image" src="slider/img/02.jpg" />
                <img data-u="thumb" src="slider/img/02.jpg" />
            </div>
            <div data-p="144.50" style="display: none;">
                <img data-u="image" src="slider/img/03.jpg" />
                <img data-u="thumb" src="slider/img/03.jpg" />
            </div>
            <div data-p="144.50" style="display: none;">
                <img data-u="image" src="slider/img/04.jpg" />
                <img data-u="thumb" src="slider/img/04.jpg" />
            </div>
            <div data-p="144.50" style="display: none;">
                <img data-u="image" src="slider/img/05.jpg" />
                <img data-u="thumb" src="slider/img/05.jpg" />
            </div>
            <div data-p="144.50" style="display: none;">
                <img data-u="image" src="slider/img/06.jpg" />
                <img data-u="thumb" src="slider/img/06.jpg" />
            </div>
            <div data-p="144.50" style="display: none;">
                <img data-u="image" src="slider/img/07.jpg" />
                <img data-u="thumb" src="slider/img/07.jpg" />
            </div>
            <div data-p="144.50" style="display: none;">
                <img data-u="image" src="slider/img/08.jpg" />
                <img data-u="thumb" src="slider/img/08.jpg" />
            </div>
            <div data-p="144.50" style="display: none;">
                <img data-u="image" src="slider/img/09.jpg" />
                <img data-u="thumb" src="slider/img/09.jpg" />
            </div>
            <div data-p="144.50" style="display: none;">
